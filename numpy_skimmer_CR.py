...
if isSignal==1:
	...
	sumW_file = "/cmsuf/data/store/user/t2/users/nikmenendez/skimmed/NanoAOD/2017/signal/control_sel/"+dataset+".txt"
elif isMC=="1":
	...
	sumW_file = "/cmsuf/data/store/user/t2/users/nikmenendez/skimmed/NanoAOD/2017/control_sel/"+dataset+".txt"
else:
...
for ev in tqdm(range(len(nMuon))):
	...
	for i in range(n_Zs):
		...
		Z1DeltaM = abs(Z1Mass-Zmass)
		if (Z1DeltaM > minZ1Mass): continue
